...
PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    'bert-base-uncased': "https://huggingface.co/google-bert/bert-base-uncased/blob/main/pytorch_model.bin",
...
PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    'bert-base-uncased': "https://huggingface.co/google-bert/bert-base-uncased/blob/main/config.json",
    ...
    'zen-model': "https://huggingface.co/zhihan1996/zen-model/resolve/main/config.json",
}
...
class ZenModel(ZenPreTrainedModel):
    ...
    def forward(self, input_ids,
        ...
        device = next(self.parameters()).device if list(self.parameters()) else input_ids.device
