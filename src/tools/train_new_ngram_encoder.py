...
@click.option("--ngram", help="The ngram encoder config file for the old ngram encoder.")
@click.option(
    "-o",
    "--out",
    default="/home/peter/llm_projects/ZENforDNA/resources/ngram-encoder-hg38-gue-all-v0.json",
    help="Save dir for ngram encoder",
    type=str,
)
def main(data: str, ngram, out: str):
    ...
    ngram_encoder = NgramEncoder.from_file(ngram)
    new_ngram_encoder = ngram_encoder.get_new_ngram_encoder_from_data(data_tokenized, freq_threshold=16)
